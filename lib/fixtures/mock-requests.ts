...
export const mockRequests: AcademicRequest[] = [
  ...
  },
  {
    ...
    currentState: { code: 'DEVUELTA', name: 'Devuelta para corrección', isFinal: false },
    priority: 'normal',
  ...
  },
  {
    ...
    type: 'novedad_notas',
    status: 'en_revision',
    stateName: 'En revisión financiera',
    currentState: { code: 'EN_REVISION_FINANCIERA', name: 'En revisión financiera', isFinal: false },
    priority: 'normal',
