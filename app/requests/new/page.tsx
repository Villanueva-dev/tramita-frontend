...
export default function NewRequestPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setErrors({ form: err instanceof Error ? err.message : 'No se pudo registrar la solicitud.' })
      setSubmitting(false)
    }
  }
      ...
      <div className="mx-auto flex max-w-4xl flex-col gap-6">
        ...
        {Object.keys(errors).length > 0 && (
          ...
          >
            ...
            <span>
              {errors.form ?? 'Hay campos que requieren su atención. Revise los mensajes resaltados a continuación.'}
            </span>
          </div>
        )}
